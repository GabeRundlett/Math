static constexpr double PI = 3.141592653589793238,
						...
						COEL_MATH_ONE_OVER_PI = 0.318309886183790671,
						COEL_MATH_ONE_OVER_TAU = 0.159154943091895335,
						COEL_MATH_ONE_OVER_HALF_PI = 0.636619772367581343,
						COEL_MATH_ONE_OVER_3F = -1.66666666666666666666e-01,
						COEL_MATH_ONE_OVER_5F = 8.33333333333333333333e-03,
						COEL_MATH_ONE_OVER_7F = -1.98412698412698412698e-04,
...
#define DMOD(x, m) \
	(x < 0.0 ? (int)(x / m - 1) * m - x : x - (int)(x / m) * m)
#define DMOD_PI(x) \
	(x < 0.0 ? (int)(x * COEL_MATH_ONE_OVER_PI - 1) * PI - x : x - (int)(x * COEL_MATH_ONE_OVER_PI) * PI)
#define DMOD_TAU(x) \
	(x < 0.0 ? (int)(x * COEL_MATH_ONE_OVER_TAU - 1) * TAU - x : x - (int)(x * COEL_MATH_ONE_OVER_TAU) * TAU)
#define DMOD_HALF_PI(x) \
	(x < 0.0 ? (int)(x * COEL_MATH_ONE_OVER_HALF_PI - 1) * HALF_PI - x : x - (int)(x * COEL_MATH_ONE_OVER_HALF_PI) * HALF_PI)

#define FMOD(x, m) \
	(x < 0.f ? (int)(x / m - 1) * m - x : x - (int)(x / m) * m)
#define FMOD_PI(x) \
	(x < 0.f ? (int)(x * (float)COEL_MATH_ONE_OVER_PI - 1) * (float)PI - x : x - (int)(x * (float)COEL_MATH_ONE_OVER_PI) * (float)PI)
#define FMOD_TAU(x) \
	(x < 0.f ? (int)(x * (float)COEL_MATH_ONE_OVER_TAU - 1) * (float)TAU - x : x - (int)(x * (float)COEL_MATH_ONE_OVER_TAU) * (float)TAU)
#define FMOD_HALF_PI(x) \
	(x < 0.f ? (int)(x * (float)COEL_MATH_ONE_OVER_HALF_PI - 1) * (float)HALF_PI - x : x - (int)(x * (float)COEL_MATH_ONE_OVER_HALF_PI) * (float)HALF_PI)
