...
namespace Coel {
	namespace Math {
		...
		template <>
		struct Vector<unsigned char, 4> {
			unsigned char r, g, b, a;
			constexpr Vector(unsigned char r, unsigned char g, unsigned char b, unsigned char a)
				: r(r), g(g), b(b), a(a) {}
			constexpr Vector(unsigned int hex)
				: r(char(hex >> 24)), g(char(hex >> 16)), b(char(hex >> 8)), a(char(hex >> 0)) {}
		};
	} // namespace Math
} // namespace Coel
