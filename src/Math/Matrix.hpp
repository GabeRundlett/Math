...
namespace Math {
    ...
    template <typename T> struct Matrix<T, 2, 2> {
        ...
        constexpr Matrix(const Vector<T, 2> &v1, const Vector<T, 2> &v2);
    ...
    template <typename T> struct Matrix<T, 3, 3> {
        ...
        constexpr Matrix(const Vector<T, 3> &v1, const Vector<T, 3> &v2, const Vector<T, 3> &v3);
    ...
    template <typename T> struct Matrix<T, 4, 4> {
        ...
        constexpr Matrix(const Vector<T, 4> &v1, const Vector<T, 4> &v2, const Vector<T, 4> &v3,
                         const Vector<T, 4> &v4);
